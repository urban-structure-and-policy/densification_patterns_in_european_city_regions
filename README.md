...
<img src="https://github.com/user-attachments/assets/4edad485-8cce-4a3a-8a3f-acbc9192087b" width="600">
...
### Prerequisites
The main parts of the workflow runs in [R](https://www.r-project.org/). For some processing steps [Python](https://www.python.org/), [QGIS](https://qgis.org/), and [ArcGIS](https://www.arcgis.com/index.html) are required. Further, an API and a local instance of [openrouteservice](https://openrouteservice.org/) is needed. Further details on the software used can be found [here](https://github.com/urban-structure-and-policy/densification_patterns_in_european_city_regions/blob/main/software_used.md).

### Description of the code
The file [00_run_all.Rmd](https://github.com/urban-structure-and-policy/densification_patterns_in_european_city_regions/blob/main/code/00_run_all.Rmd) gives and overview on all processing steps and describes them in more detail. The processing steps which are implemented in R can be run directly form the run_all script. All other steps have to be executed separatly, as explained in run_all at the respective location.
